...
function InterpreterError(message, functionality) {
...
function evaluate(env, expr) {
  ...
  // function calls replace with that function
    ...
    throw new InterpreterError('unsupported binary operator', expr.operator)
  }
    ...
    throw new InterpreterError('unknown AST expression type' + expr.type)
  }
}
